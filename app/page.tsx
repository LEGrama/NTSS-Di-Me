    ...
    <main className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-20">
        ...
        <header className="text-center mb-24 max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-800 max-w-2xl mx-auto font-light leading-relaxed">
        ...
        {/* 서비스 특징 */}
        <section className="grid md:grid-cols-3 gap-px mb-24 max-w-5xl mx-auto bg-black">
          <div className="bg-white p-10 hover:bg-gray-50 transition-colors">
            <h3 className="text-2xl font-light mb-4 text-black tracking-tight">전문 촬영</h3>
          ...
          <div className="bg-white p-10 hover:bg-gray-50 transition-colors">
            <h3 className="text-2xl font-light mb-4 text-black tracking-tight">
              디지털 메뉴판
            </h3>
            <p className="text-gray-600 font-light leading-relaxed">
          ...
          <div className="bg-white p-10 hover:bg-gray-50 transition-colors">
            <h3 className="text-2xl font-light mb-4 text-black tracking-tight">빠른 작업</h3>
            <p className="text-gray-600 font-light leading-relaxed">
        ...
        {/* 대기명단 폼 */}
        <section className="border border-black p-12 md:p-16 max-w-2xl mx-auto">
          ...
          <div className="mt-10 text-center text-xs text-gray-500 font-light">
            <p>이메일은 안전하게 보관되며, 마케팅 용도로만 사용됩니다.</p>
          </div>
        </section>

        {/* 푸터 */}
        <footer className="mt-24 text-center text-gray-400 text-xs font-light">
